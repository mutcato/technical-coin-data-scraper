...
class Summary:
    ...
    def get_volume_in_usdt(self):
        volume_in_usdt = Decimal(self.ticker.measures["close"]) * Decimal(self.ticker.measures["volume"])
    ...
    def insert(self):
        ...
        try:
            self.table.put_item(
                Item={"ticker": str(self.ticker), "interval_metric": self.ticker.interval + "_close", "volume_in_usdt": volume_in_usdt},
